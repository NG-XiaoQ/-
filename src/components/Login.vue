      ...
      <div class="register_f">
        <div class="nav">
          <div class="navs">
            <ul>
              <router-link to="/">
                <li @click="changes">会员登录</li>
              </router-link>
              <router-link to="/">
                <li>|</li>
              </router-link>
              <router-link to="/">
                <li @click="changes2">管理员登录</li>
              </router-link>
            </ul>
          </div>
        </div>
        <div class="nasevt1" v-if="msg">
          <!-- <Navigation/> -->
        ...
        <div class="nasevt2" v-else>
          <div class="navigation">
            <div class="Maxbox">
              <span class="simages"></span>
              <input v-focus type="text" placeholder="请输入会员ID" v-model="name" @keyup="vconf()">
            </div>
            <div class="Maxbox">
              <span class="simagest"></span>
              <input type="password" placeholder="请输入密码" @keyup="vconf()" v-model="searcBarCode">
        ...
        <div class="dlubtn" @click="changef" v-if="msg">
          <div class="gotob">
            <router-link to>
        ...
        <div class="dlubtn" @click="changefs" v-else>
          <div class="gotob">
            <router-link to>
              <span v-if="zzz">点击登录</span>
              <span v-else>{{ message }}</span>
...
export default {
  ...
  methods: {
    ...
    changefs() {
      ...
      var arr1 = this.goodsList.filter(
